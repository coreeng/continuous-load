...
func (s *Server) registerHandlers() {
	...
	s.router.HandleFunc("/status/ingress/{code:[0-9]+}", s.statusHandler).Methods("GET", "POST", "PUT").Name("status-ingress")
	s.router.HandleFunc("/status/service/{code:[0-9]+}", s.statusHandler).Methods("GET", "POST", "PUT").Name("status-service")
